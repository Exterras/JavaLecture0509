...
public class DeleteSwingJoinMunni extends JFrame implements ActionListener {

	JPanel p;
	JTextField tfId; // ID
	JPasswordField pfPwd; // 비밀번호
	JButton btnCancel, btnDelete; // 취소, 삭제 버튼
	GridBagLayout gb;
	GridBagConstraints gbc;
	int x = 350;
	int y = 150;

	public DeleteSwingJoinMunni() {
		super("회원삭제");
